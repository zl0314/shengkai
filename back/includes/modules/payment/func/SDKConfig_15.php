...
define("SDK_SIGN_CERT_PATH",'/home/wwwroot/certs/700000000000001_15_acp.pfx');// 签名证书路径
//define("SDK_SIGN_CERT_PATH",'D:\certs\700000000000001_15_acp.pfx');// 签名证书路径
...
//define("SDK_ENCRYPT_CERT_PATH",'D:\certs\verify_sign_acp.cer');// 密码加密证书（这条用不到的请随便配）
