    ...
    public function audit_bearer() {
        ...
        if ($audit_bearer == 3) {
            ...
            if(substr($bearer_info['mobile'],0,2) == '82'){
                ...
                sendsms($bearer_info['mobile'], "【盛开体育】您已提交的持票人{$bearer_info['cn_customer_name']}审核不通过，请重新填写。【400-885-0132】");
            }
            //----hechengbin --- end ----
            ...
            if(substr($bearer_info['mobile'],0,2) == '82'){
                ...
                sendsms($bearer_info['mobile'], "【盛开体育】您已提交的持票人{$bearer_info['cn_customer_name']}审核成功，您可以在管理中心查看和下载购票凭证。【400-885-0132】");
            }
            //----hechengbin --- end ----
