...
//echo ROOT_PATH . 'includes/inc_constant.php';
...
//require(ROOT_PATH . 'framework/util/qiniu/path.php');
//require(ROOT_PATH . 'framework/util/qiniu/function.php');
...
$db = new cls_mysql($db_host, $db_user, $db_pass, $db_name) or die(mysql_error(0));
...
$sess = new cls_session($db, $ecs->table('sessions'), $ecs->table('sessions_data'), 'ECSCP_ID') or die(mysql_error());
