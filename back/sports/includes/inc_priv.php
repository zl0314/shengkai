...
$purview['05_users_wx'] = 'users_manage';
...
$purview['game'] = 'Game/index';
$purview['02_hotel'] = 'Hotel/index';
$purview['agent'] = 'Agent/index';
$purview['agent_order'] = 'Agent/index';
$purview['examine'] = 'Agent/index';
$purview['01_roomtype'] = 'Hotel/index';
$purview['pitch'] = 'Pitch/index';
$purview['05_team'] = 'Team/index';
$purview['11_batch'] = 'Batch/index';
$purview['08_banner'] = 'Banner/index';
$purview['08_banner'] = 'Banner/index';
/**小组管理start**/
$purview['04_color'] = 'Color/index';//小组管理
$purview['04_color'] = 'Color/add';
$purview['04_color'] = 'Color/edit';
$purview['04_color'] = 'Color/remove';
/**小组管理end**/
/**套餐订单管理 start**/
//$purview['06_set_meal_order'] = 'Set_meal_order/index';//小组管理
//$purview['06_set_meal_order'] = 'Set_meal_order/update';
//$purview['06_set_meal_order'] = 'Set_meal_order/edit';
/**套餐订单管理 end**/
/**套餐管理 start**/
//$purview['set_meal'] = 'Set_meal/index';//小组管理
//$purview['set_meal'] = 'Set_meal/remove';
//$purview['set_meal'] = 'Set_meal/edit';
/**套餐管理 end**/

//新版套餐--start
$purview['combo'] = 'Combo/index';//小组管理
$purview['combo'] = 'Combo/add';//小组管理
$purview['combo'] = 'Combo/update';//小组管理update
$purview['combo'] = 'Combo/remove';
$purview['combo'] = 'Combo/edit';
//新版套餐 --end

/**广告管理 start**/
$purview['07_advert'] = 'Advert/index';//小组管理
$purview['07_advert'] = 'Advert/remove';
$purview['07_advert'] = 'Advert/edit';
/**广告管理 end**/
/**机票管理 start**/
$purview['space'] = 'Space/index';//小组管理
$purview['space'] = 'Space/remove';
$purview['space'] = 'Space/edit';
$purview['08_airticket'] = 'Airticket/index';//小组管理
$purview['08_airticket'] = 'Airticket/remove';
$purview['08_airticket'] = 'Airticket/edit';
/**机票管理 end**/


//合同管理
$purview['01_contract_list'] = 'contract_list';
$purview['02_contract_add'] = 'contract_add';
