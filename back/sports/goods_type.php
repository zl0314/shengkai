...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    {
        admin_log(addslashes($_POST['cat_name']), 'add', 'goods_type');// 记录日志
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    if ($db->autoExecute($ecs->table('goods_type'), $goods_type, 'UPDATE', "cat_id='$cat_id'") !== false)
    {
        ...
        admin_log(addslashes($_POST['cat_name']), 'edit', 'goods_type');// 记录日志
        $links = array(array('href' => 'goods_type.php?act=manage', 'text' => $_LANG['back_list']));
...
elseif ($_REQUEST['act'] == 'remove')
{
    ...
    if ($exc->drop($id))
    {
        ...
        admin_log(addslashes($name), 'remove', 'goods_type');// 记录日志
