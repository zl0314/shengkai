...
class GameModel extends Model
{
    ...
    public function get_all_good_for_game($game_id, $region_id, $rank = '')
    {
        if (empty($game_id)) {
            exit("非法数据");
        } else {
...
AND
    ...
    public function get_all_good_for_sche($game_id, $region_id, $sche_id, $rank = '')
    {
        if (empty($game_id)) {
            exit("非法数据");
        } else {
